...
def main():
    ...
    if is_mocked:
        ...
        response_size = st.sidebar.selectbox(
            "Response size", [ResponseSize.SMALL, ResponseSize.MEDIUM, ResponseSize.LARGE]
        )
    ...
    if collection_name == COL_STATE_OF_THE_UNION:
        ...
        query = st.text_input(
            "Enter your query here", "Comment intégrer ses émotions avec la méthode en trois temps ?"
        )
